...
#             # Limit the number of snippets to avoid token limit issues
#             if i >= 3:
...
#     def create_review_prompt(self, code: str, knowledge_base: List[Dict[str, Any]], language: str) -> ChatPromptTemplate:
...
#     def review_code(self, code: str, file_path: Optional[str] = None, knowledge_base: Optional[List[Dict[str, Any]]] = None) -> str:
#         """Review the provided code and return feedback."""
#         language = get_language_from_extension(file_path) if file_path else "Unknown"
        
#         # If no knowledge base is provided, use an empty one
...
class CodeReviewer:
    ...
    def review_code(self, code: str, file_path: Optional[str] = None, knowledge_base: Optional[List[Dict[str, Any]]] = None) -> Dict[str, Any]:
        ...
        #     print(f"[DEBUG] Snippet {idx} Metadata:", meta)  # Debugging
